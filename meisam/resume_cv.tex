...
\name{Meisam}{Malekzadeh}

\email{meisammalekzadeh@gmail.com}
\homepage{http://mybitbird.github.io}
\github{Mybitbird}
...
\position{Software Engineer, Full-Stack Developer} % Your expertise/fields


\makecvfooter{\today}{Meisam Malekzadeh~~~·Full-Stack Developer~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
